...
| **3** | **Sistemi Lineari Sparsi** | Metodi iterativi (Jacobi e Gauss-Seidel). Ottimizzazione computazionale delle matrici di iterazione senza inversione esplicita. | [Apri Schema](./Tipologia3_Metodi_Iterativi.md) |
...
| **5b** | **Minimi Quadrati** | Risoluzione di sistemi sovradeterminati (Equazioni Normali via Cholesky/cho_solve e fattorizzazione QR economica). | [Apri Schema](./Tipologia5bis_Minimi_Quadrati.md) |
...
| **8** | **Equazioni Differenziali (ODE)** | Risoluzione del problema di Cauchy confrontando metodi espliciti (Eulero Avanti, RK4) e impliciti (Eulero Indietro) con analisi di stabilità. | [Apri Schema](./Tipologia8_ODE.md) |
